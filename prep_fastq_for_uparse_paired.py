...
script_info={}
script_info['brief_description']="""Prepare raw Illumina sequences for processing with UPARSE by demultiplexing. This version is used for paired end reads that will later be merged."""
